      ...
      <div className="mx-auto max-w-6xl px-6 py-16">
        <div className="mb-10">
          ...
          <p className="text-white/70 mb-8 max-w-2xl text-base leading-relaxed">
            Open to opportunities in Platform Reliability, Observability, AIOps, and roles involving GenAI (RAG) operationalization.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-3">
            ...
            >
              ...
              <div className="min-w-0">
                ...
                <div className="text-xs break-all">praveen.ai.platform@gmail.com</div>
              </div>
            </a>
            <a
            ...
            >
              ...
              <div className="min-w-0">
                ...
                <div className="text-xs break-all">+91 9392981851</div>
              </div>
            </a>
            <a
            ...
            >
              ...
              <div className="min-w-0">
                ...
                <div className="text-xs break-all">github.com/praveen-ai-platform</div>
              </div>
            </a>
            <a
              href="/resume.docx"
